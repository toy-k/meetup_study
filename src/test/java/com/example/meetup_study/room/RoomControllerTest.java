...
//                () -> assertEquals(requestRoomDto.getLocation(), createdRoomDto2.getLocation()),
...
//        CategoryEnum updatedCategory = CategoryEnum.STUDY;
//
...
//                () -> assertThat(updatedRoomDtoResponse.getLocation()).isEqualTo(updatedMeetupLocation),
...
//        assertThat(deletedRoomDtoResponse.getLocation()).isEqualTo(createdRoomDto.getLocation());
